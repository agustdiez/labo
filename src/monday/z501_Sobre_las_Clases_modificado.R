...
# La distribución de BAJA+1 y BAJA+2 sigue la misma distribución en distintas variables.
# No existe una distinción entre ambas y ambas clases se comportan de forma similar a nivel de separación de 
# árboles.
...
# Al sumar dos clases se está tocando la proporción. Cómo se trabaja con la proporción?
# Lo que más afecta en el revalúo de la clase
...
# No. Cambia el punto de corte
## ¿Dejamos plata sobre la mesa?

# Estamos en train, no aun en test
...
# Se cree que se fortalece el modelo, pero tiene que ver con poner gente que se va 
# a ir mezclándola

# Al mezclar las clases, se deben redefinir los puntos de corte.
...
# El punto de corte puede ser un parámetro más en la fase de optimización

# Qué se manda a Kaggle? TIene sentido cortar por el n? Si esa cantidad es fija, no 
# se van a estar enviando todas las hojas con una determinada probabilidad.

# El punto de corte no necesariamente va a ser el mismo para los parámetros utilizados
# Los rangos acotados sobre donde puede funcionar bien quedaron definidos previamente

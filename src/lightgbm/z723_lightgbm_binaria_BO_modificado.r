...
## Experimentación de marzo respecto a enero
## 1) Features a agregar al modelo
## 2) De esas features, no se va a agregar variables que no aporten demasiado a la predicción
## 3) Busqueda de parámetros y comparar enero con marzo. En marzo volver a entrenar con umbrales y experimentar con la cant. de envios
## 4)


## LEarning rate mientras más bajo mejor.
## HAcer una corrida solamente con el min_data_in_leaf primero. Es un muy buen modelo.
hs <- makeParamSet( 
         ...
         makeIntegerParam("envios",           lower= 5000L   , upper= 15000L) ## Envios 
        )

## Qué parámetros faltan?
## bagginge fraction, extra tree, y alguna regularizacion
...
## Ver de poner iteraciones como mínimo en 200
...
## Parámetros: editar en hs, de parámetros básicos
  ...
  param_basicos  <- list( objective= "binary",
                          ...
                          min_gain_to_split= 0.0, #por ahora, lo dejo fijo ## No se está usando regularización
                          lambda_l1= 0.0,         #por ahora, lo dejo fijo ## No se está usando regularización
                          lambda_l2= 0.0,         #por ahora, lo dejo fijo ## No se está usando regularización

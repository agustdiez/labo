...
hs <- makeParamSet( 
         ...
         makeNumericParam("feature_fraction", lower=    0.45  , upper=    1.0),
         makeIntegerParam("min_data_in_leaf", lower=    0L   , upper=  8000L),
         makeIntegerParam("num_leaves",       lower=   25L   , upper=  1024L),
...
PARAM$trainingstrategy$semilla_azar   <- 732497  #Aqui poner la propia semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 732497  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy

...
PARAM <- list()
PARAM$experimento <- "ZZ9410_semillerio_ensamble_modelo5"
PARAM$exp_input <- "HT9420_TRAINING2019202_CUARTA"


# PARAM$modelos  <- 2
PARAM$modelo <- 5 # se usa el mejor de la OB, pero a futuro podria variar esto

...
PARAM$exp_input <- "ZZ9410_semillerio_ensamble_modelo1"
...
base_dir <- "D:\\OneDrive\\Personal\\Maestria Data Mining\\economia_finanzas\\"
...
ksemillas <- lapply(strsplit(archivos, "_"), function(partes_nombre_archivo) {
    ...
    # Version AGD}
    # 1      2          3        4       5  6  7   8
    # ZZ9410_semillerio_ensamble_modelo1_M1_S1_S30_598669_resultados

    return(partes_nombre_archivo[8]) # la posicion de la semilla en el nombre es 7
})
...
for (archivo in archivos) {
    ...
    ksemilla <- strtoi(strsplit(archivo, "_")[[1]][8])
    print(ksemilla)

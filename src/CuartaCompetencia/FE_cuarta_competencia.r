...
setwd("D:/OneDrive/Personal/Maestria Data Mining/economia_finanzas")  #Establezco el Working Directory
...
PARAM  <- list()
PARAM$experimento  <- "CA9060_CUARTA"
...
#grabo el dataset
fwrite( dataset,
        file=  "dataset_reparado_cuarta.csv.gz",
        logical01= TRUE,
        sep= "," )
...
#Parametros del script
PARAM  <- list()
PARAM$experimento  <- "DR9141_CUARTA"

PARAM$exp_input  <- "CA9060_CUARTA"
...
dataset_input  <- paste0( "./exp/", PARAM$exp_input, "/dataset_reparado_cuarta.csv.gz" )
...
fwrite( dataset,
        file="dataset_drift_0_fijo_cuarta.csv.gz",
        sep= "," )
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "FE9250_CUARTA"

PARAM$exp_input  <- "DR9141_CUARTA"
...
#cargo el dataset donde voy a entrenar
#esta en la carpeta del exp_input y siempre se llama  dataset.csv.gz
dataset_input  <- paste0( "./exp/", PARAM$exp_input, "/dataset_drift_0_fijo_cuarta.csv.gz" )
dataset  <- fread( dataset_input )
...
#grabo el dataset
fwrite( dataset,
        "dataset_lags2_tendencia4_CUARTA.csv.gz",
        logical01= TRUE,
        sep= "," )

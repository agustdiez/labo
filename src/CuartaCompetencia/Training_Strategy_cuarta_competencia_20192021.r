...
PARAM  <- list()
PARAM$experimento <- "TS9320_TRAINING201920202021_CUARTA"

PARAM$exp_input  <- "FE9250_CUARTA"

PARAM$future       <- c( 202109 )

#[201901, 202105]

PARAM$final_train  <- c( 201904,201905,201906,201907,201908,201909,201910,201911,201912,202001,202002, 202011, 202012, 202101, 202102, 202103,202104,202105)

PARAM$train$training     <- c( 201904,201905,201906,201907,201908,201909,201910,201911,201912,202001,202002, 202011, 202012, 202101, 202102, 202103,202104,202105)
...
dataset_input  <- paste0( "./exp/", PARAM$exp_input, "/dataset_lags2_tendencia4_CUARTA.csv.gz" )
